...
import { ScrollView , Alert, View, Text, TextInput, TouchableOpacity, Image, ActivityIndicator, FlatList, StyleSheet, PermissionsAndroid, ToastAndroid, BackHandler } from 'react-native';

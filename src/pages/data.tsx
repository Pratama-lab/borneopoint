...
import { ScrollView , Alert, View, Text, TextInput, TouchableOpacity, Image, ActivityIndicator, FlatList, StyleSheet, PermissionsAndroid, ToastAndroid, Clipboard } from 'react-native';

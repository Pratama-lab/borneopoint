...
class InfoDetail extends React.Component {
    ...
    componentDidMount = () => {
        axios.get('https://admin.borneopoint.co.id/api/get_media_detail', {params: {
    ...
    <ScrollView style={{ backgroundColor: 'white' }}>
        <View style={{ width: '100%', alignItems: 'center', marginTop: wp('3%') }}>
            <FastImage source={{ uri: 'https://admin.borneopoint.co.id/storage/media_images/'+this.state.image }} style={{ width: wp('90%'), height: wp('40%'), borderRadius: wp('2.22223%'), marginTop: wp('2%'), marginBottom: wp('2%') }} />
        </View>

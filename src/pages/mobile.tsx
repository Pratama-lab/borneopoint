...
import { ScrollView , Alert, View, Text, TextInput, TouchableOpacity, Image, ActivityIndicator, FlatList, StyleSheet, PermissionsAndroid, BackHandler, ToastAndroid } from 'react-native';
        ...
        <ScrollView style={{ padding: wp('5%'), backgroundColor: 'white' }}>
            <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flexDirection: 'row' }}>
                      <View style={{ borderBottomWidth: 2, flexDirection: 'row', width: wp('73%') }}>
                        <TextInput
                        ...
                        <View style={{ alignItems: 'center', justifyContent: 'center', width: wp('18%') }}>
                          {this.state.selectedOperator === 'three' && (
                          ...
                          {this.state.selectedOperator === 'smartfren' && (
                            <FastImage source={{ uri: 'https://cdn.mobilepulsa.net/img/logo/pulsa/small/smart.png' }} style={{ width: '100%', height: wp('10%') }} />
                          )}
                        </View>
                      </View>

    ...
    {this.props.route.params.itemType === 'voucher' && (
        ...
        <ScrollView style={{ padding: wp('5%') }}>
            <View>
                ...
                {this.state.selectedOperator !== undefined && this.state.selectedOperator !== -1 ?
                  <>
                    <View style={{ marginTop: wp('5%') }}>
                      <Text style={{fontWeight: 'bold', fontSize: wp('5%')}}>Claim Coupon</Text>
                    </View>
                    <View style={{ borderRadius: wp('2.222223%'), elevation: 2, marginTop: wp('3%'), marginBottom: wp('1%'), flexDirection: 'row', aspectRatio: 328/46, overflow: 'hidden', width: wp('90%')}}>
